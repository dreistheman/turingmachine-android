...
public class TuringMachine implements Serializable{
    ...
    //static ArrayList<String> simulationList  = new ArrayList<>();
    ArrayList<String> simulationList;
        ...
        while(!CurrentState.equals(AcceptState) && !CurrentState.equals(RejectState))
        {
            ...
            if (silentmode == false)
            {
                if (CurrentSymbol>0)
                {
                    ...
                    //insert to arraylist:
                    simulationList.add(Tape.substring(0, CurrentSymbol) + " " + CurrentState + " " + Tape.substring(CurrentSymbol));
                }
                else
                {
