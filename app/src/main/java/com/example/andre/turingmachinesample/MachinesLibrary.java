...
public class MachinesLibrary {
    ...
    public static TuringMachine Equation1()
    {
        TuringMachine newTM = new TuringMachine();
        newTM.addState("q1");
        newTM.addState("q2");
        ...
        newTM.setAcceptState("qa");
        //newTM.setRejectState("qr");
        newTM.addTransition("q1", '1', "q2", 'x', true);
        newTM.addTransition("q2", '1', "q2", '1', true);
        newTM.addTransition("q2", '0', "q2", '0', true);
        newTM.addTransition("q2", '_', "q3", '_', false);
        newTM.addTransition("q3", '0', "q4", '_', false);
        newTM.addTransition("q4", '1', "q4", '1', false);
        newTM.addTransition("q4", '0', "q4", '0', false);
        newTM.addTransition("q4", 'x', "q1", 'x', true);
        newTM.addTransition("q1", '0', "q5", '0', true);
        newTM.addTransition("q1", '_', "qa", '_', true);
        newTM.addTransition("q5", '0', "q5", '0', true);
        newTM.addTransition("q5", '_', "qa", '_', true);
        return newTM;
    }
